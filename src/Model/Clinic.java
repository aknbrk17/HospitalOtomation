...
public class Clinic {
	...
	public boolean addClinicr(String name) throws SQLException {
	...
	public ArrayList<User> getClinicDoctorList(int clinic_id) throws SQLException{
		...
		try {
			Connection con = conn.connDb();
			st =  con.createStatement();
			rs = ((java.sql.Statement) st).executeQuery("SELECT u.id , u.tcno , u.type , u.name, u.password FROM worker w LEFT JOIN  user u ON w.user_id = u.id WHERE clinic_id =  " + clinic_id);
			while(rs.next()) {
