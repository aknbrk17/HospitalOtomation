...
public class HastaGUI extends JFrame {
	...
	public HastaGUI(Hasta hasta) throws SQLException {
		...
		w_scrollDoctor.setBounds(10, 30, 272, 301);
		...
		lblNewLabel_1.setBounds(10, 5, 106, 24);
		...
		lblPoliklinikAd.setBounds(286, 10, 153, 26);
		w_appointment.add(lblPoliklinikAd);

		JComboBox select_clinic = new JComboBox();
		select_clinic.setBounds(286, 45, 150, 35);
		...
		lblPoliklinikAd_1.setBounds(286, 123, 153, 26);
		...
		btn_selDoctor.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 20));
		btn_selDoctor.setBounds(286, 153, 150, 35);
		w_appointment.add(btn_selDoctor);

		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(440, 30, 261, 301);
		...
		lblNewLabel_1_1.setBounds(440, 5, 106, 24);
		w_appointment.add(lblNewLabel_1_1);

		JLabel lblPoliklinikAd_1_1 = new JLabel("Randevu");
		lblPoliklinikAd_1_1.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 20));
		lblPoliklinikAd_1_1.setBounds(286, 231, 153, 26);
		...
		btn_addAppoint.setBounds(286, 261, 150, 35);
