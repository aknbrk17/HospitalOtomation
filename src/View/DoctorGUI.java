...
public class DoctorGUI extends JFrame {
	...
	public DoctorGUI(Doctor doctor) throws SQLException{
		...
		select_date.setBounds(10, 10, 130, 28);
		...
		select_time.setBounds(151, 10, 89, 28);
		...
		btn_addWhour.setBounds(250, 10, 103, 28);
		w_whour.add(btn_addWhour);
		
		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(0, 57, 711, 264);
		...
		btn_deleteWhour.setBounds(598, 10, 103, 28);
